...
namespace UIAnimatorCore
{
	...
	{
		new public static string EditorDisplayName { get { return "Transform & Fade"; } }
		...
		{
			base.OnInspectorGUI (a_stepIndex, a_animType, a_serializedObject, a_onAnimatedStateChanged);
